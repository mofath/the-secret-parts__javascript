...
var person = {
  ...
  age: calcAge(this.year), // global

  printNameAndGreet: function () {
    var self = this; // prson
    printName(self.name); // pass person

    function greet() {
      // console.log(this); // global // can't say obj.inner
...
animal.printNameAndGreet = person.printNameAndGreet;
animal.age = person.age;


animal.printNameAndGreet();
