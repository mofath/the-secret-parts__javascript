// Js Engine 
// it takes a JS file and translate it into machine code the computer can run
...
// Parser: it does something called lexical analysis, 
// which breaks the code into something called tokens
// And this token is formed into what is calles AST (Abstract Syntax Tree)

// Interpreter vs Compiler
// In programming there are two ways to translate our code to machine language; Interpreter and Compiler
...
// Yes, initially when JavaSript frist came out,
// JavaScript engine like SpiderMonkey interpreted JavaScript
// But things have evolved now we don't have interprters 
// we also use compilers to optimize code
...
// Most of the major implementations (v8, SpiderMonkey, etc)
// include what’s called a “just-in-time compiler”. 
...
// As this just-in-time-compiler technology improves performance, 
// the lines between “compiled” and “interpreted” start to blur.

// Why not use machine code from the beginning?
// This needs the compilation to be done on the server 
// and browsers needs to agree on an executable format to run JavaScript, 
// back in the day it was not feasible to acheive that
